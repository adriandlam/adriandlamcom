...
Originally, I was looking to make a micro ATX build, but was fortunate that my good ol' friend had gifted me a Dell PowerEdge T630 Server. I'll be going through the hardware and software I use in my home lab setup, as well as possible use cases for it, for those that are looking to do something similar.
